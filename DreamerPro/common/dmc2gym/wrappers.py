...
class DMCWrapper(core.Env, EnvBase):
    ...
    def __init__(
        ...
        self._observation_space = spaces.Box(   0, 255,  (64,64, 3,), dtype=np.uint8)
    ...
    def observation_space(self):
        return spaces.Dict({'image': self._observation_space})
    ...
    def action_space(self):
        return spaces.Dict({'action': self._norm_action_space})
    ...
    def noisy_render(self, mode='rgb_array', height=None, width=None, camera_id=0):
        obs = self.render(
            mode=mode,
            height=height,
            width=width,
